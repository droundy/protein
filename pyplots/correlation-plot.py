...
for i in range(1,num_plots):
    ...
    pylab.ylim(1.1*np.amin(data_full[i]),1.1*np.amax(data_full[i]))
...
elif sys.argv[1] == 'randst' and sys.argv[5] == '94.00':
#    pylab.title(r'Temporal correlation of shape B')
    pylab.title(r'mannik B, $\tau_c = %.3g$ sec $T = %.3g$ sec (ratio %.2g)'
               % (1/rate, period, 1/(rate*period)))
...
elif sys.argv[1] == 'stad' and sys.argv[4] == '1.18':
#    pylab.title(r'Temporal correlation of stadium B')
    pylab.title(r'stadium B, $\tau_c = %.3g$ sec $T = %.3g$ sec (ratio %.2g)'
               % (1/rate, period, 1/(rate*period)))
elif sys.argv[1] == 'p':
