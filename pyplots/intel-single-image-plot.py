...
#plt.colorbar(ticks=[])
plt.tight_layout()
print 'saving as  intel-single-image.pdf'
#plt.savefig(load.print_string("intel-single-image-plot",""), transparent=True)
plt.savefig("intel-single-image.pdf", transparent=True)
