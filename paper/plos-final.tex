...
e.g. Ref.~\cite{kuramoto1978diffusion}), or if this irregularity is
...
We implement the reaction-diffusion model of Huang \emph{et
  al.}~\cite{huang2003dynamic}.  Fig~\ref{fig:reactions} shows the
...
Fig~\ref{image-p} shows a series of color plots of the density of
...
Fig~\ref{image-p} begins about 300 seconds into the simulation and
...
stadium \emph{B}), shown in Fig~\ref{randst-plot-ave}.  All of the
...
\bibitem{adams2009bacterial}
Adams DW, Errington J (2009) Bacterial cell division: assembly, maintenance and
  disassembly of the z ring.
\newblock Nature Reviews Microbiology 7: 642--653.
\bibAnnoteFile{adams2009bacterial}

\bibitem{lutkenhaus2007assembly}
Lutkenhaus J (2007) Assembly dynamics of the bacterial mincde system and
  spatial regulation of the z ring.
\newblock Annu Rev Biochem 76: 539--562.
\bibAnnoteFile{lutkenhaus2007assembly}

\bibitem{shen2010examination}
Shen B, Lutkenhaus J (2010) Examination of the interaction between ftsz and
  mincn in e. coli suggests how minc disrupts z rings.
\newblock Molecular microbiology 75: 1285--1298.
\bibAnnoteFile{shen2010examination}

\bibitem{shapiro2009and}
Shapiro L, McAdams HH, Losick R (2009) Why and how bacteria localize proteins.
\newblock Science 326: 1225--1228.
\bibAnnoteFile{shapiro2009and}

\bibitem{yu1999ftsz}
Yu XC, Margolin W (1999) Ftsz ring clusters in min and partition mutants: role
  of both the min system and the nucleoid in regulating ftsz ring localization.
\newblock Molecular microbiology 32: 315--326.
\bibAnnoteFile{yu1999ftsz}

\bibitem{meacci2005min}
Meacci G, Kruse K (2005) Min-oscillations in escherichia coli induced by
  interactions of membrane-bound proteins.
\newblock Physical biology 2: 89.
\bibAnnoteFile{meacci2005min}

\bibitem{huang2003dynamic}
Huang KC, Meir Y, Wingreen NS (2003) {Dynamic structures in Escherichia coli:
  spontaneous formation of MinE rings and MinD polar zones}.
\newblock Proceedings of the National Academy of Sciences 100: 12724--12728.
\bibAnnoteFile{huang2003dynamic}

\bibitem{kerr2006division}
Kerr RA, Levine H, Sejnowski TJ, Rappel WJ (2006) Division accuracy in a
  stochastic model of min oscillations in escherichia coli.
\newblock Proceedings of the National Academy of Sciences of the United States
  of America 103: 347--352.
\bibAnnoteFile{kerr2006division}

\bibitem{mannik2009bacterial}
M{\"a}nnik J, Driessen R, Galajda P, Keymer JE, Dekker C (2009) Bacterial
  growth and motility in sub-micron constrictions.
\newblock Proceedings of the National Academy of Sciences 106: 14861--14866.
\bibAnnoteFile{mannik2009bacterial}

\bibitem{corbin2002exploring}
Corbin BD, Yu XC, Margolin W (2002) Exploring intracellular space: function of
  the min system in round-shaped escherichia coli.
\newblock The EMBO journal 21: 1998--2008.
\bibAnnoteFile{corbin2002exploring}

\bibitem{fange2006noise}
Fange D, Elf J (2006) Noise-induced min phenotypes in e. coli.
\newblock PLoS computational biology 2: e80.
\bibAnnoteFile{fange2006noise}

\bibitem{varma2008min}
Varma A, Huang KC, Young KD (2008) The min system as a general cell geometry
  detection mechanism: Branch lengths in y-shaped escherichia coli cells affect
  min oscillation patterns and division dynamics.
\newblock Journal of bacteriology 190: 2106--2117.
\bibAnnoteFile{varma2008min}

\bibitem{mannik2012robustness}
M{\"a}nnik J, Wu F, Hol FJ, Bisicchia P, Sherratt DJ, et~al. (2012) Robustness
  and accuracy of cell division in escherichia coli in diverse cell shapes.
\newblock Proceedings of the National Academy of Sciences 109: 6957--6962.
\bibAnnoteFile{mannik2012robustness}

\bibitem{mannik2010bacteria}
M{\"a}nnik J, Sekhavati F, Keymer J, Dekker C (2010) Bacteria in submicron
  channels and microvalves.
\newblock Proc of MicroTAS 2010, Groningen, The Netherlands : 1346--1348.
\bibAnnoteFile{mannik2010bacteria}

\bibitem{kuramoto1978diffusion}
Kuramoto Y (1978) Diffusion-induced chaos in reaction systems.
\newblock Progress of Theoretical Physics Supplement 64: 346--367.
\bibAnnoteFile{kuramoto1978diffusion}

\bibitem{meinhardt2001pattern}
Meinhardt H, de~Boer PA (2001) Pattern formation in escherichia coli: a model
  for the pole-to-pole oscillations of min proteins and the localization of the
  division site.
\newblock Proceedings of the National Academy of Sciences 98: 14202--14207.
\bibAnnoteFile{meinhardt2001pattern}

\bibitem{kruse2002dynamic}
Kruse K (2002) A dynamic model for determining the middle of< i> escherichia
  coli</i>.
\newblock Biophysical journal 82: 618--627.
\bibAnnoteFile{kruse2002dynamic}

\bibitem{hu2002dynamic}
Hu Z, Gogol EP, Lutkenhaus J (2002) Dynamic assembly of mind on phospholipid
  vesicles regulated by atp and mine.
\newblock Proceedings of the National Academy of Sciences 99: 6761--6766.
\bibAnnoteFile{hu2002dynamic}

\bibitem{shih2002division}
Shih YL, Fu X, King GF, Le T, Rothfield L (2002) Division site placement in e.
  coli: mutations that prevent formation of the mine ring lead to loss of the
  normal midcell arrest of growth of polar mind membrane domains.
\newblock The EMBO journal 21: 3347--3357.
\bibAnnoteFile{shih2002division}

\bibitem{bonny2013membrane}
Bonny M, Fischer-Friedrich E, Loose M, Schwille P, Kruse K (2013) Membrane
  ...
  formation.
\newblock PLoS computational biology 9: e1003347.
\bibAnnoteFile{bonny2013membrane}

\bibitem{halatek2012highly}
Halatek J, Frey E (2012) Highly canalized mind transfer and mine sequestration
  explain the origin of robust mincde-protein dynamics.
\newblock Cell Reports 1: 741--752.
\bibAnnoteFile{halatek2012highly}

\bibitem{meacci2006mobility}
Meacci G, Ries J, Fischer-Friedrich E, Kahya N, Schwille P, et~al. (2006)
  Mobility of min-proteins in escherichia coli measured by fluorescence
  correlation spectroscopy.
\newblock Physical biology 3: 255.
\bibAnnoteFile{meacci2006mobility}

\bibitem{loose2011min}
...
\newblock Nature structural \& molecular biology 18: 577--583.
\bibAnnoteFile{loose2011min}

\bibitem{huang2004min}
Huang KC, Wingreen NS (2004) Min-protein oscillations in round bacteria.
\newblock Physical biology 1: 229.
\bibAnnoteFile{huang2004min}

\bibitem{kruse2007experimentalist}
Kruse K, Howard M, Margolin W (2007) An experimentalist's guide to
  computational modelling of the min system.
\newblock Molecular microbiology 63: 1279--1284.
\bibAnnoteFile{kruse2007experimentalist}

\bibitem{fischer2010intra}
Fischer-Friedrich E, Meacci G, Lutkenhaus J, Chat{\'e} H, Kruse K (2010)
  Intra-and intercellular fluctuations in min-protein dynamics decrease with
  cell length.
\newblock Proceedings of the National Academy of Sciences 107: 6134--6139.
\bibAnnoteFile{fischer2010intra}

\bibitem{lawson2013spatial}
Lawson MJ, Drawert B, Khammash M, Petzold L, Yi TM (2013) Spatial stochastic
  dynamics enable robust cell polarization.
\newblock PLoS computational biology 9: e1003139.
\bibAnnoteFile{lawson2013spatial}

\bibitem{robb2014stochastic}
Robb ML, Shahrezaei V (2014) Stochastic cellular fate decision making by
  multiple infecting lambda phage.
\newblock PloS one 9: e103636.
\bibAnnoteFile{robb2014stochastic}

\bibitem{oguz2014stochastic}
Oguz C, Palmisano A, Laomettachit T, Watson LT, Baumann WT, et~al. (2014) A
  stochastic model correctly predicts changes in budding yeast cell cycle
  dynamics upon periodic expression of cln2.
\newblock PloS one 9: e96726.
\bibAnnoteFile{oguz2014stochastic}

\bibitem{fu2013deterministic}
Fu G, Sabnis A, Harrison RW (2013) A deterministic-stochastic crossover
  algorithm for simulation of complex biochemical systems.
\newblock In: Computational Advances in Bio and Medical Sciences (ICCABS), 2013
  IEEE 3rd International Conference on. IEEE, pp. 1--7.
\bibAnnoteFile{fu2013deterministic}

\bibitem{rudiger2014stochastic}
R{\"u}diger S (2014) Stochastic models of intracellular calcium signals.
\newblock Physics Reports 534: 39--87.
\bibAnnoteFile{rudiger2014stochastic}

\bibitem{hattne2005stochastic}
Hattne J, Fange D, Elf J (2005) Stochastic reaction-diffusion simulation with
  mesord.
\newblock Bioinformatics 21: 2923--2924.
\bibAnnoteFile{hattne2005stochastic}

\bibitem{git}
Schulte J, Zeto R, Roundy D (2015).
\newblock {MinD simulation github repository}.
\newblock \doi{10.5281/zenodo.16449}.
\newblock \urlprefix\url{http://github.com/jeffschulte/protein}.
\bibAnnoteFile{git}

\bibitem{kraus1996crosstalk}
Kraus M, Wolf B, Wolf B (1996) Crosstalk between cellular morphology and
  calcium oscillation patterns insights from a stochastic computer model.
\newblock Cell calcium 19: 461--472.
\bibAnnoteFile{kraus1996crosstalk}
...
\bibAnnoteFile{gillespie1977exact}

\bibitem{zhang2007gaussian}
Zhang B, Zerubia J, Olivo-Marin JC (2007) Gaussian approximations of
  fluorescence microscope point-spread function models.
\newblock Applied Optics 46: 1819--1829.
\bibAnnoteFile{zhang2007gaussian}

\bibitem{pierucci1972chromosome}
Pierucci O (1972) Chromosome replication and cell division in escherichia coli
  at various temperatures of growth.
\newblock Journal of bacteriology 109: 848--854.
\bibAnnoteFile{pierucci1972chromosome}

\bibitem{stricker2002rapid}
Stricker J, Maddox P, Salmon E, Erickson HP (2002) Rapid assembly dynamics of
  the escherichia coli ftsz-ring demonstrated by fluorescence recovery after
  photobleaching.
\newblock Proceedings of the National Academy of Sciences 99: 3171--3175.
\bibAnnoteFile{stricker2002rapid}
