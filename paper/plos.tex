...
\section*{Abstract}
  ...
  predict spatially irregular oscillations\fixme{, although they are still somewhat more bipolar than seen in experiment}.
  We further report simulations of flattened but more symmetric
  shapes, and find that it \fixme{may be} the flattening and lateral expansion
...
bottom of the cell.  \fixme{this is where Ill need to add the volumes} Fig.~\ref{fig:corr-B} shows this plot for shape
...
\section*{Conclusion}
\fixme{We find a certain amount of qualitive agreement between our stochastic simulations and experiments showing disrupted MinD oscillations in asymmetric flattened E. coli cells.}  We find agreement between our stochastic simulations and experiments
...
a spatially irregular sequence of locations, \fixme{albeit with a somewhat more course scale bipolar regularity.}  This result builds upon
