...
\fixme{
  ...
  \item \blue{David} Still need to fix periods on.  \blue{About this
    point - I updated the data and it seems the result is defferent
    from before - the stadium shapes seem to be temporally correlated
    for much longer compared with the shape A than before.}
    correlation plots
  \end{enumerate}
}
...
It's worth pointing out that this is a significant result, since for
irregular shapes it would be reasonable to hypothesize a chaotic
system, which would be shown by irregular determinisitic data.  From
