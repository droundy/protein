...
\section*{Abstract}
  ...
  predict spatially irregular oscillations as observed in experiment\fixme{, although they are generally more bipolar}.
  We further report simulations of flattened but more symmetric
  shapes, and find that it \fixme{may be?} is the flattening and lateral expansion
...
a spatially irregular sequence of locations, \fixme{albeit with a with more course scale bipolar regularity.}  This result builds upon
