...
\begin{abstract}
  ...
  deterministic models of Min-system to simulate cells with flattened
  cell shapes.  The deterministic model predicts strong bipolar
  oscillations, in contradiction with the experimentally observed
  behavoir, while the stochastic model, which is based on the same
  ...
  causes the irregular oscillation behavoir.
\end{abstract}

\keywords{\fixme{E. Coli | MinD | oscillation | stochastic | deterministic | simulation}}

\abbreviations{\fixme{SAM, self-assembled monolayer; OTS,
octadecyltrichlorosilane}}


\dropcap{I}t is vital that during the process of bacterial cell division a cell
...
\fixme{look for easily cut citations.}
