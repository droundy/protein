...
These studies largely confirm the results
...
\begin{figure}
  ...
  \caption{Temporal correlation function of the total MinD found in
    ...
    decay time of 246 seconds, so that it takes roughly 4.6 periods
    for the behavoir to decohere.  For the stadium \emph{A}, the same
    model shows an oscillation period of 51 seconds and decay time of
