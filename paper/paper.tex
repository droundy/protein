...
\begin{abstract}
  ...
  shapes.  The deterministic model is seen to be largely inadequate in
  reproducing the qualitatively irregular behavoir, while the
  stochastic model, based on the same differential equations, is able
  to accurately predict what has been seen.  We also conclude that it
  is indeed the irregularity of the cell shape that is responsible for
