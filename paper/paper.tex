...
that this method is inconsistent with experiment, and cannot be
relied upon for predictions of the behavior of the MinD system.
\fixme{Confirm others? What failures have already been seen? Is this
  the most dramatic?}
