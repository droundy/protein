...
Figures~\ref{Vbox}~and~\ref{Vbox2}).  When the shape is small enough
...
indefinately.  Figure~\ref{Vbox} shows the smaller size, for which the
...
the double oscillation that seen in Figure~\ref{Vbox2}.  The second
plot shown in Figure~\ref{Vbox2} shows a slightly larger cell for
