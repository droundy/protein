...
We have made and studied different types of plots and movies that show
the change in concentration of MinD over time. We have found that the
...
stadium shaped cells, agreeing well with Mannik's experimental
findings.
...
designed to look like Mannik cells show well the inadequacy of the
deterministic method of simulation and conversely the accuracy of the
stochastic method.  The stochastic method movies (and arrow plots of
...
regular, exhibiting locations of maxima that do not vary.  The
deterministic method is seen to be inadequate.
...
methods compare in terms of experimental acuracy, we are intersted to
...
flattened, pancake like form of our irregularly shaped cells, but from
the top down they look as pills do. In two dimensions they are
composed of a rectangle with two half ellipse connected on either end.
They are also made to have a large volume similar to the Mannik
shapes.
