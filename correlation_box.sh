...
# srun --job-name="corr stad 2.35 1.32 full 0.00 10000.00" python pyplots/density-correlation.py stad 0.25 2.35 1.32 0.00 15.00 full_array 0.00 10000.00 &
# srun --job-name="corr stad 2.35 1.32 exact 0.00 6000.00" python pyplots/density-correlation.py stad 0.25 2.35 1.32 0.00 15.00 exact 0.00 6000.00 &
