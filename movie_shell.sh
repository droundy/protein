...
srun --job-name="mov-im-create p 3.00 0.50 full 500 750" python pyplots/movie-image-creation.py p 3.00 0.50 0.00 0.00 15.00 full_array 500.00 750.00 &
srun --job-name="mov-im-create randst 18.60 28.60 full 500 850" python pyplots/movie-image-creation.py randst 0.25 18.60 28.60 94.00 15.00 full_array 500.00 850.00 &
srun --job-name="mov-im-create randst 18.50 18.50 full 500 850" python pyplots/movie-image-creation.py randst 0.25 18.50 18.50 95.00 15.00 full_array 500.00 850.00 &
srun --job-name="mov-im-create stad 2.92 1.18 full 500 850" python pyplots/movie-image-creation.py stad 0.25 2.92 1.18 0.00 15.00 full_array 500.00 850.00 &
srun --job-name="mov-im-create stad 2.35 1.32 full 500 850" python pyplots/movie-image-creation.py stad 0.25 2.35 1.32 0.00 15.00 full_array 500.00 850.00 &
...
# srun --job-name="mov-maker randst 18.60 28.60 full 500 850" python pyplots/movie-maker.py randst 0.25 18.60 28.60 94.00 15.00 full_array 500.00 850.00 &
# srun --job-name="mov-maker randst 18.50 18.50 full 500 850" python pyplots/movie-maker.py randst 0.25 18.50 18.50 95.00 15.00 full_array 500.00 850.00 &
# srun --job-name="mov-maker stad 2.92 1.18 full 500 850" python pyplots/movie-maker.py stad 0.25 2.92 1.18 0.00 15.00 full_array 500.00 850.00 &
# srun --job-name="mov-maker stad 2.35 1.32 full 500 850" python pyplots/movie-maker.py stad 0.25 2.35 1.32 0.00 15.00 full_array 500.00 850.00 &
